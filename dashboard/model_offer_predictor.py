...
class ModelPredictor:
    ...
    def get_price_predictions(self, your_offers_path):
        """
        ...
        if self.model is not None and self.metadata is not None:
            your_offers_df = pd.read_csv(your_offers_path)  # Load your offers dataframe
    ...
    def _load_model_and_metadata(self, model_path, metadata_path):
        try:
            ...
            # Load the metadata (column names and dtypes)
    ...
    def _predict_and_merge(self, df):
        try:
